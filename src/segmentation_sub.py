...
class InferenceNode(Node):
    def __init__(self):
        ...
        # Subscribe to UNCOMPRESSED image topic
    ...
    def compressed_to_image(self, compressed_msg):
        ...
        cv_image = cv2.imdecode(np_arr, cv2.IMREAD_COLOR)  # BGR OpenCV image

        # Convert OpenCV image back to ROS Image message
        return cv_image  # Return the OpenCV image directly since we need BGR format for processing
